  ...
  return [
    {
      ...
      content: "# Privacy Policy\n\nLast updated: January 2026\n\nThis Privacy Policy describes how ParkZipply collects, uses, and shares your information...",
      metaTitle: "Privacy Policy | ParkZipply",
      metaDescription: "Learn how ParkZipply protects your privacy and handles your personal data.",
      status: "published",
    ...
    },
    {
      ...
      content: "# Terms of Service\n\nEffective: January 2026\n\nBy using ParkZipply, you agree to these Terms of Service...",
      metaTitle: "Terms of Service | ParkZipply",
      metaDescription: "Read the terms and conditions for using ParkZipply parking services.",
      status: "published",
      createdAt: new Date("2025-06-01"),
      updatedAt: now,
      publishedAt: new Date("2025-06-01"),
    ...
    },
    {
      ...
      slug: "about-us",
      title: "About Us",
      content: "# About ParkZipply\n\nParkZipply is the leading parking reservation platform...",
      status: "draft",
...
function generateMockUsers(): User[] {
  return [
    ...
    { id: "user_5", email: "admin@parkzipply.com", firstName: "Admin", lastName: "User", phone: "+1 555-9999", role: "admin", status: "active", emailVerified: true, createdAt: new Date("2023-01-01"), preferences: { notifications: { email: true, sms: false, marketing: false } } },
